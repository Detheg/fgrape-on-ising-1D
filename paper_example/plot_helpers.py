...
from helpers import experiment_param_formats
...
def open_from_dir(dir_, exclude="", sort_by=[]):
        ...
        with open(os.path.join(dir_, file), 'r') as f:
            ...
            for param, p_type in experiment_param_formats + [("s", int)]:
                ...
                if match:
                    ...
                    pass#print(f"Parameter {param} not found in filename {file}.")
    ...
    if sort_by:
        data.sort(key=lambda x: tuple(x[1][param] for param in sort_by))
    ...
    return fidelities_mat, params_each